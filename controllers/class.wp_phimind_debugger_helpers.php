<?php 
	...
	$wp_phimind_debugger_form_boolean = array();
	$wp_phimind_debugger_form_boolean[0] = array(1, "Yes");
	$wp_phimind_debugger_form_boolean[1] = array(0, "No");
	$GLOBALS["wp_phimind_debugger_form_boolean"] = $wp_phimind_debugger_form_boolean;

	class wp_phimind_debugger_helpers
	{
		...
		public static function form_input($name, $options = array())
		{
			...
			array_walk($options, 'wp_phimind_debugger_helpers::concat_string_key');
